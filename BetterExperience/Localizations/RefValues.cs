namespace BetterExperience.Localizations {
    public class RefValues {
        public const string ExperienceText = "{BEE_3KhOym}Experience values";

        public const string PowerText = "{=BEE_S7nfeK}Power";
        public const string PowerHint = "{=BEE_475wxq}Power value for experience equation (base*(level^power)";
